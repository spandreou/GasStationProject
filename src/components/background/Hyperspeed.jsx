  ...
  useEffect(() => {
    ...
    class App {
      constructor(containerNode, options = {}) {
        ...
        this.renderer.setSize(containerNode.offsetWidth, containerNode.offsetHeight, false);
        this.renderer.setPixelRatio(window.devicePixelRatio);
        this.composer = new EffectComposer(this.renderer);
        containerNode.append(this.renderer.domElement);

        this.camera = new THREE.PerspectiveCamera(
          options.fov,
          containerNode.offsetWidth / containerNode.offsetHeight,
          0.1,
          10000,
        );
      ...
      loadAssets() {
        ...
        return new Promise((resolve) => {
          ...
          assets.smaa = {};
          searchImage.addEventListener('load', function onLoad() {
            assets.smaa.search = this;
            manager.itemEnd('smaa-search');
          });

          areaImage.addEventListener('load', function onLoad() {
      ...
      init() {
        ...
        material.onBeforeCompile = (shader) => {
          shader.vertexShader = shader.vertexShader.replace(
            ...
            options.distortion.getDistortion || distortion_vertex,
          );
        };
