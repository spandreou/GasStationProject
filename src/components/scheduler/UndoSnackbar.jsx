      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={onUndo}
            disabled={!isAdmin}
            className="inline-flex items-center gap-1 rounded-lg bg-slate-900/90 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-sm hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <RotateCcw size={14} />
            Αναίρεση
          </button>
