...
const Hyperspeed = lazy(() => import("../background/Hyperspeed"));
...
export default function TenantApp({ hostContext, routePath = "/", children }) {
  ...
  const revealClass = isInterfaceReady
    ? "app-content-reveal app-content-reveal--ready relative z-10"
    : "app-content-reveal relative z-10";

  return (
    <div className="relative isolate min-h-screen overflow-hidden" data-tenant-mode={hostContext.mode}>
